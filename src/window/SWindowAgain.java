...
public class SWindowAgain {
	...
	public static SWindowAgain instance;
	...
	public static void main(String[] args) {
		SWindowAgain sw = create("iiii", 0, new Handle() {
			@Override
	...
	public static SWindowAgain create(String title, int mode, Handle handle) {
		return SWindowAgain.create(title, new float[] {0f, 0f, 0f}, mode, handle);
	}
	
	public static SWindowAgain create(String title, float[] colorData, int mode, Handle handle) {
		running = true;
		return new SWindowAgain(title, colorData, mode, handle);
	}

	private SWindowAgain(String name, float[] colorData, int mode, final Handle handle) {
		instance = this;
		this.mode = mode;
		this.handle = handle;
	...
	private Shell createShell(final SWindowAgain window, String title, float alpha) {
		Shell shell;
		int shellMode = mode & 0b11111111111111111111111111111000;
		shell = new Shell(display, shellMode);
